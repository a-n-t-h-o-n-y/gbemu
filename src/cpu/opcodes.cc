...
void CPU::opcode_dec(RegisterPair& reg) { reg.decrement(); }
...
/* DI */
void CPU::opcode_di() { interrupts_enabled = false; }
...
void CPU::opcode_inc(RegisterPair& reg) { reg.increment(); }
...
/* RET */
void CPU::opcode_ret() { stack_pop(pc); }
