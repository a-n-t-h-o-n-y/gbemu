...
void CPU::opcode_02() { opcode_ld(to_address(bc), a); }
...
void CPU::opcode_0A() { opcode_ld(a, to_address(bc)); }
...
void CPU::opcode_12() { opcode_ld(to_address(de), a); }
...
void CPU::opcode_1A() { opcode_ld(a, to_address(de)); }
...
void CPU::opcode_22() { opcode_ldi(to_address(hl), a); }
...
void CPU::opcode_2A() { opcode_ldi(a, to_address(hl)); }
...
void CPU::opcode_32() { opcode_ldd(to_address(hl), a); }
void CPU::opcode_33() { opcode_inc(sp); }
void CPU::opcode_34() { opcode_inc(to_address(hl)); }
void CPU::opcode_35() { opcode_dec(to_address(hl)); }
void CPU::opcode_36() { opcode_ld(to_address(hl)); }
void CPU::opcode_37() { opcode_scf(); }
void CPU::opcode_38() { opcode_jr(Condition::C); }
void CPU::opcode_39() { opcode_add_hl(sp); }
void CPU::opcode_3A() { opcode_ldd(a, to_address(hl)); }
...
void CPU::opcode_46() { opcode_ld(b, to_address(hl)); }
...
void CPU::opcode_4E() { opcode_ld(c, to_address(hl)); }
...
void CPU::opcode_56() { opcode_ld(d, to_address(hl)); }
...
void CPU::opcode_5E() { opcode_ld(e, to_address(hl)); }
...
void CPU::opcode_66() { opcode_ld(h, to_address(hl)); }
...
void CPU::opcode_6E() { opcode_ld(l, to_address(hl)); }
void CPU::opcode_6F() { opcode_ld(l, a); }
void CPU::opcode_70() { opcode_ld(to_address(hl), b); }
void CPU::opcode_71() { opcode_ld(to_address(hl), c); }
void CPU::opcode_72() { opcode_ld(to_address(hl), d); }
void CPU::opcode_73() { opcode_ld(to_address(hl), e); }
void CPU::opcode_74() { opcode_ld(to_address(hl), h); }
void CPU::opcode_75() { opcode_ld(to_address(hl), l); }
void CPU::opcode_76() { opcode_halt(); }
void CPU::opcode_77() { opcode_ld(to_address(hl), a); }
...
void CPU::opcode_7E() { opcode_ld(a, to_address(hl)); }
...
void CPU::opcode_86() { opcode_add_a(to_address(hl)); }
...
void CPU::opcode_8E() { opcode_adc(to_address(hl)); }
...
void CPU::opcode_96() { opcode_sub(to_address(hl)); }
...
void CPU::opcode_9E() { opcode_sbc(to_address(hl)); }
...
void CPU::opcode_A6() { opcode_and(to_address(hl)); }
...
void CPU::opcode_AE() { opcode_xor(to_address(hl)); }
...
void CPU::opcode_B6() { opcode_or(to_address(hl)); }
...
void CPU::opcode_BE() { opcode_cp(to_address(hl)); }
...
void CPU::opcode_E9() { opcode_jp(to_address(hl)); }
...
void CPU::opcode_CB_06() { opcode_rlc(to_address(hl)); }
...
void CPU::opcode_CB_0E() { opcode_rrc(to_address(hl)); }
...
void CPU::opcode_CB_16() { opcode_rl(to_address(hl)); }
...
void CPU::opcode_CB_1E() { opcode_rr(to_address(hl)); }
...
void CPU::opcode_CB_26() { opcode_sla(to_address(hl)); }
...
void CPU::opcode_CB_2E() { opcode_sra(to_address(hl)); }
...
void CPU::opcode_CB_36() { opcode_swap(to_address(hl)); }
...
void CPU::opcode_CB_3E() { opcode_srl(to_address(hl)); }
...
void CPU::opcode_CB_46() { opcode_bit(0, to_address(hl)); }
...
void CPU::opcode_CB_4E() { opcode_bit(1, to_address(hl)); }
...
void CPU::opcode_CB_56() { opcode_bit(2, to_address(hl)); }
...
void CPU::opcode_CB_5E() { opcode_bit(3, to_address(hl)); }
...
void CPU::opcode_CB_66() { opcode_bit(4, to_address(hl)); }
...
void CPU::opcode_CB_6E() { opcode_bit(5, to_address(hl)); }
...
void CPU::opcode_CB_76() { opcode_bit(6, to_address(hl)); }
...
void CPU::opcode_CB_7E() { opcode_bit(7, to_address(hl)); }
...
void CPU::opcode_CB_86() { opcode_res(0, to_address(hl)); }
...
void CPU::opcode_CB_8E() { opcode_res(1, to_address(hl)); }
...
void CPU::opcode_CB_96() { opcode_res(2, to_address(hl)); }
...
void CPU::opcode_CB_9E() { opcode_res(3, to_address(hl)); }
...
void CPU::opcode_CB_A6() { opcode_res(4, to_address(hl)); }
...
void CPU::opcode_CB_AE() { opcode_res(5, to_address(hl)); }
...
void CPU::opcode_CB_B6() { opcode_res(6, to_address(hl)); }
...
void CPU::opcode_CB_BE() { opcode_res(7, to_address(hl)); }
...
void CPU::opcode_CB_C6() { opcode_set(0, to_address(hl)); }
...
void CPU::opcode_CB_CE() { opcode_set(1, to_address(hl)); }
...
void CPU::opcode_CB_D6() { opcode_set(2, to_address(hl)); }
...
void CPU::opcode_CB_DE() { opcode_set(3, to_address(hl)); }
...
void CPU::opcode_CB_E6() { opcode_set(4, to_address(hl)); }
...
void CPU::opcode_CB_EE() { opcode_set(5, to_address(hl)); }
...
void CPU::opcode_CB_F6() { opcode_set(6, to_address(hl)); }
